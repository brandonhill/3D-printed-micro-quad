...
FRAME_CAM_MOUNT_THICKNESS = FRAME_BASE_THICKNESS * 2;
FRAME_HEIGHT = print_height(3);
FRAME_FLANGE_THICKNESS = FRAME_HEIGHT;
FRAME_FLANGE_WIDTH = 0;
FRAME_INSET_FACTOR = 0.15; // allows curvature of prop guards
FRAME_WALLS = 0.8;
...
BATT_DIM_600 = [52, 19, 8];
BATT_WGT_600 = 46.3;

BATT_DIM = BATT_DIM_600;
BATT_STRAP_DIM = [15.5, 1.5];
BATT_WEIGHT = BATT_WGT_600;
...
BATT_POS_INITIAL = [0, 0, -BATT_DIM[2] / 2];
